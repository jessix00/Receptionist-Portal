...
if(isset($_POST['btn-update'])){
    ...
    $vehicle = $_POST['Vehicle'];
        $update = "UPDATE form1 SET Name='$name',Meeting='$meeting',Timein='$timein', 
...
<body>
    <form method="post">
        ...
        <label>Time-In:</label><input type="time" name="Timein" placeholder="Time In" value="<?php echo $row['Timein']; ?>"><br/><br/>
